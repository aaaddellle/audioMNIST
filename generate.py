...
def _create_directory(dir_path):
    ...
    """
    #C:\Users\Lenovo\Desktop\python\audio_changed
    original_dir = os.getcwd()
    img_path = os.path.join(original_dir, dir_path, "audio_changed\generated_images")
...
def sample_and_save(captions: list,
    ...
    images = minimagen.sample(audios=captions, return_pil_images=True, **sample_args)
